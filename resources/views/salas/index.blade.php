...
<div class="container mt-5">
    <div class="tabela-main-page shadow-sm rounded-4 p-4 bg-white">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="#" class="button-orange fw-normal text-decoration-none shadow-sm"
                    ...
                    <tbody>
                        @foreach($salas as $sala)
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="color-pill shadow-sm" style="background-color: {{ $sala->cor ?? '#ccc' }};"></span>
                                </td>
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-dark shadow">
                                            <li>
                                                <a href="#" class="dropdown-item fs-13 py-2" data-bs-toggle="modal" data-bs-target="#editarSalaModal{{ $sala->id }}">
                                                    <i class="bi bi-pencil-square me-2 text-warning"></i> Editar
                                                </a>
                                            </li>
                                            <li><hr class="dropdown-divider opacity-10"></li>
                                            <li>
                                                <a href="#" class="dropdown-item text-danger fs-13 py-2" data-bs-toggle="modal" data-bs-target="#confirmarExclusaoModal{{ $sala->id }}">
            ...
            <form action="{{ route('salas.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body p-4">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nome" class="form-control input-custom" placeholder="Ex: Sala de Conferência A" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            ...
                            <input type="color" name="cor" class="form-control form-control-color w-100" style="height: 38px;" value="#3788d8">
                        </div>
                    </div>
                </div>
                <div class="modal-footer bg-light border-0">
                    <button type="button" class="btn btn-link text-muted text-decoration-none fs-13" data-bs-dismiss="modal">Cancelar</button>
                ...
                <form action="{{ route('salas.update', $sala) }}" method="POST">
                    ...
                    <div class="modal-body p-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nome" class="form-control input-custom" value="{{ old('nome', $sala->nome) }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="fw-medium fs-13 mb-1">Descrição/Localização:</label>
                            <input type="text" name="descricao" class="form-control input-custom" value="{{ old('descricao', $sala->descricao) }}" required>
                        </div>
                        <div class="row g-3">
                            <div class="col-6">
                                <label class="fw-medium fs-13 mb-1">Situação:</label>
                            ...
                            <div class="col-6">
                                ...
                                <input type="color" name="cor" class="form-control form-control-color w-100" style="height: 38px;" value="{{ old('cor', $sala->cor) }}">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer bg-light border-0">
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                <div class="modal-body text-center p-4">
                    ...
                    <p class="text-muted small">Esta ação não poderá ser desfeita. Deseja realmente remover a sala <strong>{{ $sala->nome }}</strong>?</p>
                    <div class="d-flex justify-content-center gap-2 mt-4">
                        <button type="button" class="btn btn-light border px-3 fs-13" data-bs-dismiss="modal">Não, manter</button>
