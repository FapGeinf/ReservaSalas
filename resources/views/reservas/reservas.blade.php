        ...
        <table class="table-reservas table-striped" id="reservas">
            <thead>
                <tr>
                    ...
                    <th data-label="Tipo Reserva">
                        <label class="text-light">Tipo de Reserva</label>
                    </th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td data-label="Hora Início">
                        {{ \Carbon\Carbon::parse($reserva->data_inicio)->format('d/m/Y \à\s H:i') }}
                    </td>

                    <td data-label="Hora Término">
                        {{ \Carbon\Carbon::parse($reserva->data_fim)->format('d/m/Y \à\s H:i') }}
                    </td>
                    ...
                    <td data-label="Tipo Reserva">
                        {{ ucfirst($reserva->finalidade) ?? '—' }}
                    </td>
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="{{ route('reservas.show', $reserva->id) }}"
                                        class="dropdown-item text-decoration-none text-pattern">
