...
<div class="pagina-container">
  <div class="d-flex flex-wrap">
    ...
    <div class="col-md-3" style="min-width: 300px;">
      <div class="salas-grid d-flex flex-column gap-3">
            ...
            <div class="sala-card-conteudo" style="position: relative;">
              ...
              <div class="sala-info">
                <div class="titulo-sala">
                  <span class="text-uppercase fw-semibold">{{ $sala->nome }}</span>
                  @if($situacao === 'inativa')
                    <span class="d-block s-manutencao fw-medium" style="font-size: 14px;">Sala em manutenção</span>
                  @else
                    <span class="d-block s-disponivel fw-medium" style="font-size: 14px;">Sala disponível</span>
                  @endif
                </div>
